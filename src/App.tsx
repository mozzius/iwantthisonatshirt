    ...
    <main className="container mx-auto">
      ...
      <div className="w-full flex">
        ...
        <div className="flex-1 relative flex sm:flex-col">
          ...
          <h2 className="text-red-500 text-4xl rotate-6 italic font-bold">ORIGINAL DESGIN TEESJERT</h2>
          ...
          <p className="mt-6 font-bold text-gray-700 rotate-[0.5deg] text-3xl">ONLY <span className="animate-ping text-blue-700">1</span> LEFT U BETTER HURRY</p>
          <a
